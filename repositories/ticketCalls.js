...
const queries = require("../queries/ticketsCall");

// get all calls by ticket id
const getCallsByTicketId = async (ticketId) => {
  const result = await pool.query(queries.getCallsByTicketId, [ticketId]);
  return result.rows;
};
