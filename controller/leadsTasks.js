const repo = require("../repositories/leadsTasks");

// get tasks by lead id
const getTasksByLeadId = async (req, res) => {
  try {
    const { leadId } = req.params;

    const data = await repo.getTasksByLeadId(leadId);
  ...
  try {
    ...
    if (
      ...
      return res.status(400).json({
        success: false,
        message:
          "lead_id, task_name, due_date, due_time, task_type and priority are required",
      });
    }
