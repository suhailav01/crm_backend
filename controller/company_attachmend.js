const repo = require("../repositories/company_attachment");
const fs = require("fs");
...
const getAttachmentsByCompany = async (req, res) => {
  try {
    const { company_id } = req.params;

    const result = await repo.getAttachmentsByCompany(company_id);
